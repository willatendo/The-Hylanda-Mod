...
public class HylandaConfiguredFeatures {
	...
	public static final RegistryObject<ConfiguredFeature<?, ?>> BIOQUOIA_TREE = CONFIGURED_FEATURES.register("bioquoia_tree", () -> new ConfiguredFeature<>(new BioquoiaTreeFeature(NoneFeatureConfiguration.CODEC), new NoneFeatureConfiguration()));
}
